...
{  
  ...
  G4VSolid * inside_block =
	  new G4Box("Inside Block",
		  31.115*mm, 60.146*mm, 80.01*mm); //the walls are actually thinner; set x to 31.115*mm, but 26.046 matches the shape of the inside cylinders. y dimension 64.146 appears to have trouble ->60
